...
[![Try on Spaces](https://img.shields.io/badge/%F0%9F%A4%97%20Try%20on-Spaces-blue)](https://huggingface.co/spaces/rushyrush/Kokoro-TTS-Zero)
...
### Integration Guides
 [![Helm Chart](https://img.shields.io/badge/Helm%20Chart-black?style=flat&logo=helm&logoColor=white)](https://github.com/rushyrush/Kokoro-FastAPI/wiki/Setup-Kubernetes) [![DigitalOcean](https://img.shields.io/badge/DigitalOcean-black?style=flat&logo=digitalocean&logoColor=white)](https://github.com/rushyrush/Kokoro-FastAPI/wiki/Integrations-DigitalOcean) [![SillyTavern](https://img.shields.io/badge/SillyTavern-black?style=flat&color=red)](https://github.com/rushyrush/Kokoro-FastAPI/wiki/Integrations-SillyTavern)
[![OpenWebUI](https://img.shields.io/badge/OpenWebUI-black?style=flat&color=white)](https://github.com/rushyrush/Kokoro-FastAPI/wiki/Integrations-OpenWebUi)
## Get Started
...
docker run -p 8880:8880 ghcr.io/rushyrush/kokoro-fastapi-cpu:latest # CPU, or:
docker run --gpus all -p 8880:8880 ghcr.io/rushyrush/kokoro-fastapi-gpu:latest  #NVIDIA GPU
```
...
1. Install prerequisites ():
   ...
   - Clone the repository:
        ...
        Run the [model download script](https://github.com/rushyrush/Kokoro-FastAPI/blob/master/docker/scripts/download_model.py) if you haven't already
...
Free and open source is a community effort, and there's only really so many hours in a day. If you'd like to support the work, feel free to open a PR, buy me a coffee, or report any bugs/features/etc you find during use.
  ...
  <a href="https://www.buymeacoffee.com/rushyrush" target="_blank">
    <img
